# Integration Management: Operations and Security

## Threat boundary

Out-of-process/sandbox execution, allowlisted destinations, signed webhooks, replay protection, scoped credentials, and revocation.

## Reliability

Connector failure is bulkheaded; health and queue age are observable per connector without leaking tenant payloads.
