# Evidence: Operations and Security

## Threat boundary

Separate signing identity/KMS, canonicalization, revocation, redaction, Restricted payload isolation, offline verification.

## Reliability

Bundle finalization/signing/verification latency and artifact resolution durability are measured; signing fails closed.
